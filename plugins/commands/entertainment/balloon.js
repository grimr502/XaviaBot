const config = {
  name: "balloon",
  aliases: ["balloon"],
  description: "Create balloon meme",
  usage: "[text] | [text]",
  cooldown: 3,
  permissions: [0, 1, 2],
  credits: "Dymyrius"
...
const onCall = ({ message, args, getLang }) => {
  ...
  let url = input == "https://apimeme.com/create/Running-Away-Balloon/";
  ...
  url = (text1 && text2 != null) ? `https://apimeme.com/meme?meme=Running-Away-Balloon&top=${text1}&bottom=${text2}` : url
