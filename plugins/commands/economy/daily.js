...
const langData = {
  en_US: {
    ...
    "daily.alreadyClaimed":
      "𝚈𝚘𝚞 𝚑𝚊𝚟𝚎 𝚊𝚕𝚛𝚎𝚊𝚍𝚢 𝚌𝚕𝚊𝚒𝚖𝚎𝚍 𝚢𝚘𝚞𝚛 𝚍𝚊𝚒𝚕𝚢, 𝚢𝚘𝚞 𝚌𝚊𝚗 𝚌𝚕𝚊𝚒𝚖 𝚊𝚐𝚊𝚒𝚗 𝚒𝚗 {time}. ⏱️",
    "daily.successfullyClaimed":
      "𝚈𝚘𝚞 𝚑𝚊𝚟𝚎 𝚌𝚕𝚊𝚒𝚖𝚎𝚍 𝚢𝚘𝚞𝚛 𝚍𝚊𝚒𝚕𝚢 𝚛𝚎𝚠𝚊𝚛𝚍 𝚘𝚏 ${amount}. 💵",
    "daily.failed": "𝙵𝚊𝚒𝚕𝚎𝚍!",
  },
  vi_VN: {
    "daily.selfNoData": "Dữ liệu của bạn chưa sẵn sàng",
    "daily.alreadyClaimed":
      "Bạn đã nhận thưởng hàng ngày, bạn có thể nhận lại sau {time}",
  ...
  ar_SY: {
    ...
    "daily.successfullyClaimed":
      "لقد طالبت بمكافأتك اليومية البالغة {amount}XC",
    "daily.failed": "فشل",
  },
};
...
async function onCall({ message, extra, getLang }) {
  ...
  if (result) {
    message.reply(
      getLang("daily.successfullyClaimed", { amount: global.addCommas(amount) })
    );
  } else {
